...
namespace NavigationSample.Common
{
    /// <summary>
    ...
    public class LayoutAwarePage : Page
    {
        ...
        protected virtual void GoBack(object sender, RoutedEventArgs e)
        {
            ...
            IPageNavigator navigator = ServiceLocator.Instance.Resolve<IPageNavigator>();
            if (navigator != null && navigator.CanGoBack) navigator.GoBack();
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.NavigationMode == NavigationMode.New)
            {
                ...
                // Pass it to the ViewModel if appropriate
                INavigationAware vm = DataContext as INavigationAware;
                if (vm != null)
                {
                    vm.LoadState(e.Parameter, null);
                }
            }
            else
            {
                ...
                if (vm != null)
                {
                    vm.LoadState(e.Parameter, (Dictionary<String, Object>) frameState[this._pageKey]);
                }
            }
        }
