...
namespace JulMar.Collections
{
    ...
    public class WeakReferenceList<T> : IList<T>
    {
        ...
        public WeakReferenceList(IEnumerable<T> existingData)
        {
        ...
        /// </summary>
        /// <param name="existingData">Existing data to load</param>
        public void AddRange(IEnumerable<T> existingData)
        {
            if (existingData != null)
                existingData.ForEach(Add);
        }
        ...
        public int IndexOf(T item)
        {
            ...
            {
                T value;
                if (GetItem(i, out value) && EqualityComparer<T>.Default.Equals(item,value))
                    return i;
            }
