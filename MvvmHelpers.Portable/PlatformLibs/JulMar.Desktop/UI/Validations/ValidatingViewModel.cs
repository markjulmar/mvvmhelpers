...
namespace JulMar.UI.Validations
{
    ...
    public class ValidatingViewModel : ViewModel, IDataErrorInfo
    {
        ...
        {
            get { return this.ValidateOverride(null, this, ValidationManager.Validate(null, this)); }
        }

        string IDataErrorInfo.this[string columnName]
        {
            get { return this.ValidateOverride(columnName, this, ValidationManager.Validate(columnName, this)); }
        }
        #endregion
