...
namespace JulMar.Interactivity.Triggers
{
    /// <summary>
    ...
    public class BindingTrigger : TriggerBase<UIElement>
    {
        ...
        public BindingBase Binding
        {
            ...
            {
                this._binding = value;
                BindingOperations.SetBinding(this, InternalBindingValueProperty, this.Binding);
            }
        }
        ...
        public bool AlwaysRunOnChanges
        {
            ...
            set
            {
                this.SetValue(AlwaysRunOnChangesProperty, value);
            }
        }
        ...
        private void CheckValue(bool isSourceChange)
        {
            ...
            object newValue = this.GetValue(InternalBindingValueProperty);
            ...
            if (isSourceChange && this.AlwaysRunOnChanges)
            {
