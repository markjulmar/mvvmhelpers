...
namespace JulMar.IO
{
    ...
    sealed class RandomAccessStream : IRandomAccessStream
    {
        ...
        public IInputStream GetInputStreamAt(ulong position)
        {
            ...
            if (pos > this._stream.Length) 
                throw new IndexOutOfRangeException();
            
            this._stream.Position = pos;
            return this._stream.AsInputStream();
        }
        ...
        public IOutputStream GetOutputStreamAt(ulong position)
        {
            ...
            this._stream.Position = pos;
            return this._stream.AsOutputStream();
        }
        ...
        public ulong Size
        {
            ...
            set { this._stream.SetLength((long)value); }
        }
        ...
        {
            get { return (ulong) this._stream.Position; }
        }
        ...
        {
            this._stream.Seek((long)position, 0);
        }
