...
namespace JulMar.Mvvm
{
    ...
    public sealed class ViewModelLocator
    {
        ...
        /// </summary>
        public IViewModelLocater ViewModels { get; set; }
        ...
        private static void OnViewModelKeyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (fe != null)
            {
                ...
                {
                    IViewModelLocater vmLocater = ServiceLocater.Instance.Resolve<IViewModelLocater>();
                    object viewModel;
                    if (vmLocater.TryLocate(key, out viewModel) && viewModel != null)
                    {
