...
namespace JulMar.Interactivity
{
    ...
    public class InvokeCommand : DependencyObject, IAction
    {
        ...
        {
            get { return (PropertyPath)this.GetValue(CommandParameterPathProperty); }
            set { this.SetValue(CommandParameterPathProperty, value); }
        }
        ...
        public object Execute(object sender, object parameter)
        {
            ...
            if (commandParameter != null && this.CommandParameterPath != null)
            {
                Binding binding = new Binding { Source = commandParameter, Path = this.CommandParameterPath };
