...
namespace JulMar.Tests.Core
{
    ...
    public class MessageMediatorTest
    {
        ...
        public class DataEvent : IDataEvent
        {
            ...
            public DataEvent(string s) { this.SData = s; }
        }

        public class DataEventUpper : IDataEvent
        {
            public string SData { get; set; }
            public DataEventUpper(string s) { this.SData = s.ToUpper(); }
        }

        public class DataEventLower : IDataEvent
        {
            public string SData { get; set; }
            public DataEventLower(string s) { this.SData = s.ToLower(); }
        }
        ...
        public class TestImpl : ITest
        {
            ...
            public void Message2(IDataEvent data) { this.Count += 1; }

            [MessageMediatorTarget("test")]
            public void Message(IDataEvent data) { this.Count += 2; }

            [MessageMediatorTarget]
            public void Message(DataEvent data) { this.Count += 4; }
        }
        ...
        public class TestImplJustInterfaces : ITest
        {
            ...
            [MessageMediatorTarget]
            public void Message(IDataEvent data) { this.Count += 1; }
        }
