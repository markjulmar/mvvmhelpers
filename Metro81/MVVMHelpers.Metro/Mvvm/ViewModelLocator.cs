...
namespace JulMar.Windows.Mvvm
{
    ...
    public sealed class ViewModelLocator
    {
        ...
        private static void OnViewModelKeyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(key))
            {
                ...
                if (vmLocator.TryLocate(key, out viewModel) && viewModel != null)
                {
                    ...
                    {
                        d.SetValue(FrameworkElement.DataContextProperty, viewModel);
                    }
                }
            }
        }
        ...
        /// <param name="fe"></param>
        /// <returns></returns>
        public static string GetKey(DependencyObject fe)
        {
        ...
        public static void SetKey(DependencyObject fe, string key)
        {
