...
2.00 9/2013
Updated for Windows 8.1 with built-in behavior support
Removed FlyoutPage and flyout service - needs new support for Flyout/SettingsFlyout, etc.
Removed WatermarkTextBoxBehavior
Ported all behaviors over to new Behaviors SDK
Removed interactivity and behaviors DLLs - behaviors merged back into Helpers DLL
Updated to new MEF (2.0)
